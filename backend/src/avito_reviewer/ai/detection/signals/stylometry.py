...
Файлы, доступные фрагментом, пропускаются целиком. Текст, собранный из
диффа, — это обрывки строк вокруг изменений, и статистика на нём врёт в обе
стороны: контекстные строки дают ложную ровность, разрывы между ханками —
ложную рваность. Молчать по такому файлу честнее, чем считать по нему
