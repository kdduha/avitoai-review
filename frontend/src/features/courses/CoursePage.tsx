...
export function CoursePage() {
  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="pt-5">
        <MockNotice>
          Программы, задания, шкалы и дедлайны взяты из материалов организаторов. Ведомость настоящая
          на девять строк — они лежат в потоке 2 Tech QA дословно из таблицы организаторов, вместе с
          формулой итога и шкалой оценки; остальные строки достроены теми же распределениями, а баллы
          за конкретные задания синтетические: у бэкенда есть разбор работы по ссылке, но нет ни
          хранилища сдач, ни учебного каталога. Ячейка ведёт в разбор там, где для программы есть
          рубрика — сейчас это Go, системный дизайн и основы backend.
        </MockNotice>
        {unknownStream ? (
