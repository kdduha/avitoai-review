...
export function CoursePage() {
  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="pt-5">
        <MockNotice>
          Программы и задания взяты из материалов организаторов, оценки синтетические: у бэкенда есть
          разбор работы по ссылке, но нет ни хранилища сдач, ни учебного каталога. Ячейка ведёт в разбор
          там, где для программы есть рубрика — сейчас это Go, системный дизайн и основы backend;
          для остальных рубрику ещё предстоит собрать.
        </MockNotice>
        {unknownStream ? (
