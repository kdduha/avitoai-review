 ...
 *  — это четыре курса (MLSD, LLM, основы backend, GPU). Заданий двадцать два при
 *  двадцати домашних работах: работа по Go состоит из трёх отдельных этапов.
 *
 ...
 *
 *  Оценочных величин две, обе помечены ниже по месту: `reviewMinutes` и `cohort`
 *  там, где размер группы не назван. Настоящие размеры известны для трёх курсов
 *  из счётчика Stepik: Tech QA — 49, бизнес-модели — 38, антифрод — 22.
 */
