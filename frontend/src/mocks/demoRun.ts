/** Демо-прогон в формате ответов `/review` и `/detect`, а не в собственном:
 *  демо и живой прогон проходят через один адаптер и рисуются одним кодом.
 *  Своя форма означала бы, что расхождение с сервером всплывёт на живом ключе.
 */
